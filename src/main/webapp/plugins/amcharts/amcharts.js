...
AmCharts.RecItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l, m, n) {
        ...
        W && (W.attr({"text-anchor": ha}), W.translate(G, v), 0 !== m && W.rotate(-m, a.chart.backgroundColor), a.allLabels.push(W), this.label = W, AmCharts.setCN(p, W, a.bcn + "label"), AmCharts.setCN(p, W, n, !0), g && AmCharts.setCN(p, W, "guide"));
...
AmCharts.AmGraph = AmCharts.Class({construct: function (a) {
        ...
        isNaN(h) && (h = .8);
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, r = this.rotate, q = this.columnCount, t = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), z = this.connect, x = [], u = [], w, y, A, C, B = this.chart.graphs.length, H, D = this.dx / this.tcc, I = this.dy / this.tcc, X = f.stackType, ca = this.start, oa = this.end, S = this.scrollbar, ma = "graph-column-";
        S && (ma = "scrollbar-graph-column-");
        var pa = this.categoryAxis, ia = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex, Y = this.lineThickness, T = this.lineAlpha, ra = this.lineColorR, aa = this.dashLength, ba = this.set, sa, ha = this.getGradRotation(), O = this.chart.columnSpacing, U = pa.cellWidth, va = (U * h - q) / q;
        O > va && (O = va);
        ...
        for (J = ca; J <= oa; J++) {
            ...
            if (l && void 0 == this.openField)
                for (var tb = J + 1; tb < d.length && (!d[tb] || !(Ya = d[J + 1].axes[f.id].graphs[b]) || !Ya.values || (La = Ya.values.value, isNaN(La))); tb++)
                    ;
            var R, N, L, ea, ka = NaN, F = NaN, E = NaN, M = NaN, K = NaN, Ma = NaN, Ca = NaN, Na = NaN, Da = NaN, xa = NaN, ya = NaN, fa = NaN, ga = NaN, V = NaN, ub = NaN, vb = NaN, la = NaN, na = void 0, Ha = sb, Ra = Va, za = ra, ta, wa, wb = this.proCandlesticks, jb = this.topRadius, Za = this.pattern;
                    ...
                    case"line":
                        if (isNaN(V))
                            ...
                            if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength))
                                this.drawLineGraph(x, u, P, Q), x = [F], u = [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), l ? Ka ? (this.lineColorSwitched = ra, this.fillColorsSwitched = sb) : (this.lineColorSwitched = Ba, this.fillColorsSwitched = Ia) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors), this.dashLengthSwitched = v.dashLength;
                        ...
                        if (!isNaN(V)) {
                            ...
                            if (!(V < Kb && la < Kb || V > Lb && la > Lb)) {
                                ...
                                if (r) {
                                    ...
                                    N < n && 0 < L && (na = new AmCharts.Cuboid(e, ea, L, D - a.d3x, I - a.d3y, Ha, Ra, Y, ta, T, ha, t, r, aa, Za, jb, ma), v.columnWidth = Math.abs(ea), v.columnHeight = Math.abs(L))
                                } else {
                                    ...
                                    R < m + Z * D && 0 < L && (this.showOnAxis && (N -= I / 2), na = new AmCharts.Cuboid(e, L, ea, D - a.d3x, I - a.d3y, Ha, Ra, Y, ta, this.lineAlpha, ha, t, r, aa, Za, jb, ma), v.columnHeight = Math.abs(ea), v.columnWidth = Math.abs(L))
                                }
                            }
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(x, u, P, Q) : this.drawLineGraph(x, u, P, Q), S || this.launchAnimation();
                ...
                if (c.mouseIsOver || A || C || this.forceShow)
                    if (this.forceShow = !1, C) {
                        ...
                        if (!g.parseDates || g.equalSpacing)
                            e = Math.round(e);
                        0 !== e && (h = {type: "zoomed", target: this}, h.chart = this.chart, g.parseDates &&
                        ...
                        if (this.oneBalloonOnly) {
                            ...
                            for (g = 0; g < B.length; g++)
                                u = B[g], u.showBalloon && !u.hidden && u.balloonText && (w = r.axes[u.valueAxis.id].graphs[u.id], x = w.y, isNaN(x) || (t ? Math.abs(e - x) < q && (q = Math.abs(e - x), H = u) : Math.abs(f - x) < q && (q = Math.abs(f - x), H = u)));
...
AmCharts.AmBalloon = AmCharts.Class({construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: C - e + "," + y}, b, "easeOutSine"), m && (A.left = this.prevTX + "px", A.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = C - e;
                this.prevY = y;
                this.prevTX = l;
                this.prevTY = h
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
        ...
        if (e) {
            ...
            for (z = 0; z < e.length; z++) {
                ...
                l && (w.labelColor = y[l]);
                t[y[d]] = w;
                if (f && (b = h.categoryFunction ? h.categoryFunction(b, y, h) : b instanceof Date ? AmCharts.newDate(b, h.minPeriod) : x ? AmCharts.stringToDate(b, x) : new Date(b), b = AmCharts.resetDateToMin(b, n, p, h.firstDayOfWeek), w.category = b, w.time = b.getTime(), isNaN(w.time)))
                    continue;
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function (a) {
        ...
        if (a = this.categoryAxis)
            b = this.getAxisBounds(a, g, k, h, b), g = Math.round(b.l), k = Math.round(b.r), h = Math.round(b.t), b = Math.round(b.b);
...
AmCharts.TrendLine = AmCharts.Class({construct: function (a) {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, q = a.initialXValue, t = a.finalXValue, z = a.initialValue, x = a.finalValue, u = p.recalculateToPercents, w = b.dataDateFormat;
...
AmCharts.AmLegend = AmCharts.Class({construct: function (a) {
        ...
        this.titleWidth = 0;
        if (e = this.title)
            e = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, e, "legend-title"), e.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = e.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = h - c - b, p = 0, r = 0, q = this.container;
