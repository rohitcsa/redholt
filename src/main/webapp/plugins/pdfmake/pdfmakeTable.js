...
function ParseElement(cnt, e, p, styles) {
    ...
    switch (e.nodeName.toLowerCase()) {
        ...
        case "span":
        {
            ParseContainer(cnt, e, p, styles.concat(["font-size:5px"]));
            //p = CreateParagraph();
            break;
        }
        case "br":
        ...
        case "table":
        {
            ...
            if (!isBorder)
                t.layout = 'noBorders';
            ParseContainer(t.table.body, e, p, styles.concat(["font-size:4px"]));
        ...
        case "thead":
        {
            ParseContainer(cnt, e, p, styles.concat(["font-weight:bold"], ["font-size:5px"]));
            //p = CreateParagraph();
            break;
        }
        case "tfoot":
        ...
        case "font":
        {
            ParseContainer(cnt, e, p, styles.concat(["font-weight:bold"], ["font-size:4px"]));
            //p = CreateParagraph();
            break;
        }
        default:
